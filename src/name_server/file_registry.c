/**
 * file_registry.c - File and Folder Registry Management
 * 
 * Manages file metadata, folder hierarchy, access control lists (ACLs),
 * and permission checking. Storage server registry is in ss_registry.c.
 */
