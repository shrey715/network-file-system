...
# Source files
COMMON_SRC = src/common/network.c src/common/logger.c src/common/utils.c src/common/table.c src/common/cJSON.c
...
CLIENT_SRC = src/client/main.c src/client/commands.c src/client/parser.c src/client/input.c src/client/ai_agent.c
